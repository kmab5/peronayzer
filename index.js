...
app.post("/auto", async (req, res) => {
  ...
  avatar = avatar.data;
  avatar = avatar.substring(0, 4) + ' class="style-preview avatar" ' + avatar.substring(4);
...
app.post("/manual", async (req, res) => {
  ...
  console.log(`Seed: ${seed}, Style: ${style}, Unqname: ${unqname}, Personalities: ${req.body.personality} to ${personalities.join(", ")}, Colors: ${colors.join(", ")}`);
